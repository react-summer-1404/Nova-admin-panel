...
const [selectedRoleID, setSelectedRoleID] = useState({ value: '', label: 'Select Role'})
const [sidebarOpen, setSidebarOpen] = useState(false)
  ...
  const roleOptions = [
    ...
    { value: 'SuperAdmin', label: 'مدیر ویژه' },
  ]
  ...
  const apiParams = {
    ...
    SortType : sortType,
    Query: searchTerm,
    IsActiveUser : isActive.value != ''? isActive.value : undefined,
    IsDeletedUser: isDeleted.value != '' ? isDeleted : undefined,
