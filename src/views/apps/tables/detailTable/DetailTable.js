      ...
      <Col>
        ...
        <Col>
          <StatsHorizontal
            ...
            renderStats={<h3 className="fw-bolder mb-75">{data?.courseCommentTotal}</h3>}
          />
        </Col>
        <Col>
          <StatsHorizontal
            ...
            renderStats={<h3 className="fw-bolder mb-75">{data?.reserveUserTotal}</h3>}
          />
        </Col>
      </Col>
      <Col><CoursesGoalOverview /></Col>
    </div>
  );
};
